...
###### Stratified KFold######
def cross_validation(n_split):
  # 시드 설정 여기
  print()
  print("Cross Validation Start")

  s_kfold = StratifiedKFold(n_splits=n_split,shuffle= True,random_state=None)

  s_dataset = load_data("../dataset/train/train.csv")
