...
def train():
  ...
  # sweep_id = wandb.sweep(sweep_config, project="lr-demo")
  ...
  for i in [0.1, 0.01, 0.001, 0.0001, 0.00001,0.000001, 0.0000001] :
  ...
  # https://huggingface.co/transformers/main_classes/trainer.html#trainingarguments 참고해주세요.
    training_args = TrainingArguments(
      ...
      output_dir='./results_copy',          # output directory
      save_total_limit=5,              # number of total save model.
      save_steps= 5000,                 # model saving step.
      num_train_epochs=10,              # total number of training epochs
      learning_rate= i,
      #learning_rate= config.learning_rate, #5e-5,               # learning_rate
  ...
  #     "dataset": "Data_generator_EDA",})


  model.save_pretrained('./best_model_copy')
